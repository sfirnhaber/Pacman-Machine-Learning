...
class CornersProblem(search.SearchProblem):
    ...
    def isGoalState(self, state):
        ...
        """
        return len(state[1]) == 0 #This means there are no corner that have not been traveled to
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                ...
                successors.append(((coords, corners), action, 1))
...
def cornersHeuristic(state, problem):
    ...
    cost = 0
    otherCorners = state[1].copy()
    currentPosition = state[0]
    while len(otherCorners) > 0:
        distances = []
        ...
        otherCorners.remove(distance[1])
...
class ClosestDotSearchAgent(SearchAgent):
    ...
    def findPathToClosestDot(self, gameState):
        ...
        return search.aStarSearch(problem, heuristic=foodHeuristic)
